...
extrac_path = 'F:/EEG/dataset/SEED/SEED/ExtractedFeatures/'
label_path = 'F:/EEG/dataset/SEED/SEED/ExtractedFeatures/label.mat'
save_path = 'F:/EEG/git/seed/DGCNN-main/'
