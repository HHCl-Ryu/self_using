...
def load_DE_SEED(load_path):
    ...
    DE = datasets['DE']
    # 选择指定的通道
    selected_channels = [0, 2, 3, 4, 5, 13]  # 注意Python索引从0开始，原来的第1, 3, 4, 5, 6, 14通道对应0, 2, 3, 4, 5, 13
    DE_selected = DE[:, selected_channels, :]
    ...
    dataAll = np.transpose(DE_selected, [1,0,2])
...
def main_LOCV():
    dir = 'F:/EEG/git/seed/DGCNN-main/DE/session2/'                         #04-0.9916， 0.86    
